...
### Added
- Add graph refresh to the OpenStack InfraManager [(#563)](https://github.com/ManageIQ/manageiq-providers-openstack/pull/563)
...
- Add notifications for VM destroy Volume and Volume Snapshot actions [(#85)](https://github.com/ManageIQ/manageiq-providers-openstack/pull/85)
...
- Only update tenant mapping for the Region if it's present [(#119)](https://github.com/ManageIQ/manageiq-providers-openstack/pull/119)
...
### Fixed
- Fix autocomplete error in targeted Volume collection [(#400)](https://github.com/ManageIQ/manageiq-providers-openstack/pull/400)
...
- Improve Region refresh speed [(#216)](https://github.com/ManageIQ/manageiq-providers-openstack/pull/216)
...
- Use only hypervisor hostname to match infra host with cloud vm [(#186)](https://github.com/ManageIQ/manageiq-providers-openstack/pull/186)
- Return empty AR relation instead of nil for ::InfraManager#cloud_tenants [(#184)](https://github.com/ManageIQ/manageiq-providers-openstack/pull/184)
- Improve Targeted Refresh for Cloud and Regions [(#175)](https://github.com/ManageIQ/manageiq-providers-openstack/pull/175)
